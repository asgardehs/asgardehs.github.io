...
description: How to report security vulnerabilities in Asgard EHS projects.
permalink: /security/
---
...
page](#public-key) and on the [developer page](/developer/#verifying-commits).
...
acknowledges this](/code-of-conduct/#moderation), and the security
process inherits the same constraint. The targets below are commitments,
not guarantees — we will say so honestly if we miss them.
...
- Record the advisory in the [project changelog](/changelog/).
...
typos. Material changes recorded in the [project changelog](/changelog/).
